...
public final class VillagePlugin extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        currencyService = new CurrencyService(this, currencyConfigManager);
        ...
        globalMoneyCommand = new GlobalMoneyCommand(configManager, villageManager, currencyService);
    ...
    private void registerListeners(GuiClickListener guiClickListener) {
        ...
        pm.registerEvents(new com.example.village.listener.VillageDiscoveryListener(villageManager, configManager, this, levelService), this);
